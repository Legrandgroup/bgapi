...
class BleMeshNode(object):
    ...
    def ble_evt_mesh_node_model_config_changed(self, mesh_node_config_state, element_address, vendor_id, model_id):
        ...
        self._logger.info("EVT-Mesh Node Model Config Changed - Config State:%s - Element Address:%02X - Vendor ID:%02X - Model ID:%02X" % (config_state_str, element_address, vendor_id, model_id))
